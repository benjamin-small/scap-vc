...
impl Engine {
    ...
    // scap-vc patch: start/stop return Result instead of panicking via
    // .expect() — a failed capture start (e.g. an invalid configuration or a
    // vanished window) is an ordinary error for the embedding application.
